...
# 设计图页的筛选面板和稀有度选项位置，来自设计图页专用 UI 布局。
# 这里不复用装备页的筛选点位，因为设计图页顶部按钮和筛选弹层坐标明显不同。
DESIGN_FILTER_POINTS: Dict[str, Tuple[int, int]] = {
    "filter_button": (839, 26),
    "filter_confirm": (800, 596),
    "filter_cancel": (480, 596),
    "rarity_all": (288, 500),
    "rarity_common": (435, 500),
    "rarity_rare": (583, 500),
    "rarity_elite": (730, 500),
    "rarity_super_rare": (877, 500),
    "rarity_ultra_rare": (1025, 500),
}
